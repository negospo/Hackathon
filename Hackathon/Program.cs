...
namespace Hackathon
{
    public class Program
    {
        ...
        static void ConfigApp(WebApplication app)
        {
            ...
            // Autenticação e Autorização vêm após UseRouting
            app.UseAuthentication();
            app.UseAuthorization();

            // CORS precisa ser configurado após UseRouting e antes de UseEndpoints/MapControllers
            app.UseCors(x => x
                .AllowAnyOrigin()
                .AllowAnyMethod()
                .AllowAnyHeader());

            // MapControllers vem após UseAuthorization
            app.MapControllers();
